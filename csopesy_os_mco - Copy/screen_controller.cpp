...
std::shared_ptr<ICommand> ScreenController::generateRandomCommand(std::shared_ptr<Process> p) {
	
	scheduler->addProcess(p);
	scheduler->pushToReadyQueue(p);
	scheduler->setIsOn(true);
	scheduler->setIsStopScheduling(false);
